...
def _optimize_seam_mask(front, back, w1, out_w, out_h, flow_unreliability=None, flow_mag=None):
    ...
    for xc, side_lo, side_hi in (
        ...
        with open('mag_values.txt', 'a') as f:
            f.write(f'flow_mag at 1000, 1412: {flow_mag[1000, 1412]}\n')
            f.write(f'flow_mag at 1000, 1590: {flow_mag[1000, 1590]}\n')
            f.write(f'edge_mag at 1000, 1412: {edge_mag[1000, 1412]}\n')
            f.write(f'edge_mag at 1000, 1590: {edge_mag[1000, 1590]}\n')
            f.write(f'cost at 1000, 1412: {cost[1000, 1412]}\n')
            f.write(f'cost at 1000, 1590: {cost[1000, 1590]}\n')
            f.write(f'path at 1000: {path[1000] + x0}\n')
